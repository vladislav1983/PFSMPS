...
typedef unsigned char* FMSTR_ADDR;   /* CPU address type (use integer data type on 56F8xxx) */
...
FMSTR_BOOL FMSTR_Init(void); /* general initializations */
