...
#define PWM4_DT_COMP_MODE               0x00C0  /* Dead Time Compensation mode */

#define PWM4_DT_COMP_POLARITY_POS       0x0000
#define PWM4_DT_COMP_POLARITY_NEG       0x0020
#define PWM4_DT_COMD_UNUSED             0x0000

#define PWM4_TIME_BASE_PRIMARY          0x0000  /* PWM generator uses the primary master time base */
#define PWM4_TIME_BASE_SECONDARY        0x0008  /* PWM generator uses the secondary master time base */
...
#elif defined (__dsPIC33F__)
#define PWM1_FLT_CMP1                   0b00000000      /* Fault control signal select source CMP1 for PWM1 Gen bits */
#define PWM1_FLT_CMP2                   0b00001000      /* Fault control signal select source CMP2 for PWM1 Gen bits */
#define PWM1_FLT_CMP3                   0b00010000      /* Fault control signal select source CMP3 for PWM1 Gen bits */
#define PWM1_FLT_CMP4                   0b00011000      /* Fault control signal select source CMP4 for PWM1 Gen bits */
#define PWM1_FLT_FLT1					0b01000000      /* Fault control signal select source FLT1 for PWM1 Gen bits */
#define PWM1_FLT_FLT2					0b01001000      /* Fault control signal select source FLT2 for PWM1 Gen bits */
#define PWM1_FLT_FLT3					0b01010000      /* Fault control signal select source FLT3 for PWM1 Gen bits */
#define PWM1_FLT_FLT4					0b01011000      /* Fault control signal select source FLT4 for PWM1 Gen bits */
#define PWM1_FLT_FLT5					0b01100000      /* Fault control signal select source FLT5 for PWM1 Gen bits */
#define PWM1_FLT_FLT6					0b01101000      /* Fault control signal select source FLT6 for PWM1 Gen bits */
#define PWM1_FLT_FLT7					0b01110000      /* Fault control signal select source FLT7 for PWM1 Gen bits */
#define PWM1_FLT_FLT8					0b01111000      /* Fault control signal select source FLT8 for PWM1 Gen bits */
#endif
...
#define PWM1_FLT_IP_DIS					0x0003  /* Fault input disabled  */
...
#elif defined (__dsPIC33F__)
#define PWM2_FLT_CMP1                   0b00000000      /* Fault control signal select source CMP1 for PWM2 Gen bits */
#define PWM2_FLT_CMP2                   0b00001000      /* Fault control signal select source CMP2 for PWM2 Gen bits */
#define PWM2_FLT_CMP3                   0b00010000      /* Fault control signal select source CMP3 for PWM2 Gen bits */
#define PWM2_FLT_CMP4                   0b00011000      /* Fault control signal select source CMP4 for PWM2 Gen bits */
#define PWM2_FLT_FLT1					0b01000000      /* Fault control signal select source FLT1 for PWM2 Gen bits */
#define PWM2_FLT_FLT2					0b01001000      /* Fault control signal select source FLT2 for PWM2 Gen bits */
#define PWM2_FLT_FLT3					0b01010000      /* Fault control signal select source FLT3 for PWM2 Gen bits */
#define PWM2_FLT_FLT4					0b01011000      /* Fault control signal select source FLT4 for PWM2 Gen bits */
#define PWM2_FLT_FLT5					0b01100000      /* Fault control signal select source FLT5 for PWM2 Gen bits */
#define PWM2_FLT_FLT6					0b01101000      /* Fault control signal select source FLT6 for PWM2 Gen bits */
#define PWM2_FLT_FLT7					0b01110000      /* Fault control signal select source FLT7 for PWM2 Gen bits */
#define PWM2_FLT_FLT8					0b01111000      /* Fault control signal select source FLT8 for PWM2 Gen bits */
#endif
