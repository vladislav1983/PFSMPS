...
#define cTimer1Ticks_us                         125
#define cFMSTR_RecorderTick_us                  FMSTR_RecorderTick
...
#define cFastMeasureTaskTimerId                 1
#define cFMSTR_RecorderId                       2
#define cNumberSoftTimers                       3
...
{                                                                       \
    ...
    /* cFastMeasureTaskTimerId - Fast measure task timer */             \
    {                                                                   \
    /* Timeout ms   */  _TimeToSoftTimTicks(cFastMeasureTaskPeriodUs),  \
    /* Callback Fct */  MeasureTimerCallback                            \
    },                                                                  \
    /* FMSTR_Recorder */                                                \
    {                                                                   \
    /* Timeout ms   */  _TimeToSoftTimTicks(cFMSTR_RecorderTick_us),    \
    /* Callback Fct */  FMSTR_Recorder                                  \
    }                                                                   \
}
